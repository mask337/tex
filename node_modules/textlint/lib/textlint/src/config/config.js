...
var config_key_normalizer_1 = require("./config-key-normalizer");
...
var Config = /** @class */ (function () {
    ...
    function Config(options) {
         ...
         */
        this.disabledRules = applyNormalizerToList(config_key_normalizer_1.normalizeRuleKey, options.disabledRules ? options.disabledRules : defaultOptions.disabledRules);
        /**
         * @type {string[]} rule key list
         * rules does not includes disabledRules
         */
        this.rules = applyNormalizerToList(config_key_normalizer_1.normalizeRuleKey, options.rules ? options.rules : defaultOptions.rules).filter(function (ruleName) {
         ...
         * These rule is set `false` to options
         */
        this.disabledFilterRules = applyNormalizerToList(config_key_normalizer_1.normalizeFilterRuleKey, options.disabledFilterRules ? options.disabledFilterRules : defaultOptions.disabledFilterRules);
        /**
         * @type {string[]} filter rule key list
         */
        this.filterRules = applyNormalizerToList(config_key_normalizer_1.normalizeFilterRuleKey, options.filterRules ? options.filterRules : defaultOptions.filterRules).filter(function (ruleName) {
            return !_this.disabledFilterRules.includes(ruleName);
        });
        /**
         * @type {string[]} preset key list
         */
        this.presets = applyNormalizerToList(config_key_normalizer_1.normalizeRulePresetKey, options.presets ? options.presets : defaultOptions.presets);
        // => load plugins
        // this.rules has not contain plugin rules
        // =====================
        this.plugins = applyNormalizerToList(config_key_normalizer_1.normalizePluginKey, options.plugins ? options.plugins : defaultOptions.plugins);
        this.pluginsConfig = applyNormalizerToConfig(config_key_normalizer_1.normalizePluginKey, options.pluginsConfig ? options.pluginsConfig : defaultOptions.pluginsConfig);
        // rulesConfig
        ...
        this.rulesConfig = applyNormalizerToConfig(config_key_normalizer_1.normalizeRuleKey, objectAssign({}, presetRulesConfig, options.rulesConfig));
        // filterRulesConfig
        this.filterRulesConfig = applyNormalizerToConfig(config_key_normalizer_1.normalizeFilterRuleKey, options.filterRulesConfig || defaultOptions.filterRulesConfig);
        /**
         * @type {string[]}
         */
