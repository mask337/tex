...
export default abstract class TextLintCoreTask extends EventEmitter {
     ...
     */
    tryToGetRuleObject(ruleCreator: TextlintRuleReporter, ruleContext: Readonly<TextlintRuleContext>, ruleOptions?: TextlintRuleOptions): import("../../../../../packages/@textlint/types/src").TextlintRuleReportHandler;
    /**
     * try to get filter rule object
     */
    tryToGetFilterRuleObject(ruleCreator: TextlintFilterRuleReporter, ruleContext: Readonly<TextlintFilterRuleContext>, ruleOptions?: TextlintFilterRuleOptions): import("../../../../../packages/@textlint/types/src").TextlintFilterRuleReportHandler;
    /**
